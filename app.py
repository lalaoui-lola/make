...
from redis_seen  import filter_unseen as _filter_unseen
...
CATEGORY_EN_TO_FR_750G = {
    ...
    "breakfast brunch":      "petit-déjeuner",
    "brunch":                "brunch",
    "dinner":                "dîner",
    "supper":                "dîner",
    "appetizer":             "entrée",
    ...
    "mains courses":         "plat principal",
    "side dish":             "accompagnement",
    "side dishes":           "accompagnement",
    "vegetarian":            "végétarien",
    "vegan":                 "vegan",
    "gluten free":           "sans gluten",
    "gluten free recipe":    "sans gluten",
    "gluten free receipe":   "sans gluten",
    "low carb":              "léger",
    "low calorie":           "léger",
    "low calorie meals":     "léger",
    "high protein":          "protéiné",
    "comfort food":          "plat réconfortant",
    "easy weekday meals":    "rapide",
    "ready in 15 minutes":   "rapide",
    "quick meals":           "rapide",
    "fresh salad":           "salade",
    "salad":                 "salade",
    "salads":                "salade",
    "healthy recipe":        "végétarien",
    "healthy receipe":       "végétarien",
    "healthy breakfast idea": "petit-déjeuner",
    "healthy breakfast ideas": "petit-déjeuner",
    "cakes pastries":        "gâteau",
    "cakes":                 "gâteau",
    "pastries":              "gâteau",
        ...
        for src_name, fn in [
            ...
            try:
                ...
                if result:
                    ...
                    filtered = _filter_unseen(result, _cat_key)
                    if filtered:
                        recipes, source_used = filtered, src_name
                        break
            except Exception:
                continue
